...
public class MultiplicacaoControlador implements Initializable{/*possibilita a classe executar uma
	função antes mesmo do programa surgir na tela do computador*/
	
	@FXML
	private Button btMultiplicar; /* botão da tela chamado multiplicar*/
	
	public void onBtMultipicarAction() { /*chama método multiplicar da calculadora comum */
		
		labelResultado.setText(String.format("%.2f", CalculadoraComum.multiplicar(txtValor1.getText(), txtValor2.getText())));
	}
